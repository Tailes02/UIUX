...
public class Manager_HoaDonChiTietController extends Manager_ChuyenTrangController{
    ...
    public void initialize() {
        ...
        ObservableList<HoaDon> data = FXCollections.observableArrayList(
                new HoaDon(101, 1000000, "Nguyễn Thị Hằng", "0989958699","y"),
                new HoaDon(102, 200000, "Hoàng Thị Minh Nguyệt", "0912738073","y"),
                new HoaDon(103, 340000, "Nguyễn Thanh Mai", "09112345678","y"),
                new HoaDon(104, 450000, "Trần Ngọc Linh", "09198765432","y"),
                new HoaDon(105, 205000, "Nguyễn Ngọc Khánh", "09123456789","y"),
                new HoaDon(106, 201000, "Nguyễn Tiến Dũng", "09187654321","y"),
                new HoaDon(107, 206000, "Mai Ngọc Linh", "09134567890","y")
//                new Manager_HoaDonChiTietController.HoaDon(2, "108", "Phạm Ngọc Ngà", "09176543210",2),
//                new Manager_HoaDonChiTietController.HoaDon(2, "201", "Trần Phương Anh", "09154321098",2),
//                new Manager_HoaDonChiTietController.HoaDon(2, "202", "Lương Thanh Hà", "09189012345",3)
